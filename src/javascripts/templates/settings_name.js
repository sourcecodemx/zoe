...
buf.push("<div class=\"scroll-content\"><div class=\"page-content\"><form class=\"row\"><div class=\"col\"><div class=\"padding\"><div class=\"list\"><label class=\"item item-input\"><input id=\"username\" type=\"text\" placeholder=\"Nombre de usuario\" autocomplete=\"off\" autocapitalize=\"off\"" + (jade.attr("value", "" + (data.username) + "", true, false)) + "/></label></div>");
