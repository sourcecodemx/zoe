...
buf.push("<div class=\"scroll-content\"><div class=\"page-content\"><form class=\"row\"><div class=\"col\"><div class=\"padding\"><div class=\"list\"><label class=\"item item-input\"><input id=\"email\" type=\"email\" placeholder=\"Correo electronico\"" + (jade.attr("value", "" + (data.email) + "", true, false)) + "/></label></div>");
